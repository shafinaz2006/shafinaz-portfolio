...
function Home(){
    return(
        <section className='section intro'>
            ...
            <p className='section__text'> From </p>
            ...
            <div className='info'>
                ...
                <div className='info__right'>
                    <p className='info__text'>
                        I worked as a Quality Assurance Analyst for more than two years in Toronto. During this time, I collaborated with developers and grew interest to pursue my career as a Web Developer.
                    </p>
                    <p className='info__text'>
